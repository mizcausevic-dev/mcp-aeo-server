...
### Released
- Published **mcp-aeo-server** as a public, portfolio-grade MCP governance system.
...
### Shipped
- Cut the first coherent internal version of the product shape behind **mcp-aeo-server**.
...
- That insight became the basis for **mcp-aeo-server**.
