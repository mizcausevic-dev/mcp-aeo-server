...
What comes next is practical. The roadmap is about pushing the project deeper into real operational utility: live polling agents, richer policy authoring, posture history, and incident export paths. That direction matters because the long-term value of **mcp-aeo-server** is not the individual screen or endpoint. It is the operating discipline behind it. That is the operating discipline this repo is trying to make concrete.
